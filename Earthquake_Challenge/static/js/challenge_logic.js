...
// We create the 3rd dark view tile layer that will be an option for our map.
...
// Added a 3rd layer group for major earthquake data. 
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then((data) => {
    ...
    //Creating a tectonic plate layer with retrieved data.
    L.geoJSON(data, {
      color: "#b30000",
      weight: 2
